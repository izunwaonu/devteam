...
const AboutUs = () => {
  return (
    <>
    <Navbar/>
        <section  className="bg-white mt-9 dark:bg-gray-900">
            <div className="container px-6 py-10 mx-auto">
                <div className="lg:flex lg:items-center">
                    <div className="w-full space-y-12 lg:w-1/2 ">
                        <div>
                            <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Welcome to <br/>Dev Team Tech</h1>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16"> <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0z"/> <path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8zm8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7z"/> </svg>
                            </span>

                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Our vision</h1>

                                <p className="mt-3 text-gray-500 dark:text-gray-300">
                                Our vision at Dev Team Tech is to lead the way in transforming the 
                                digital landscape. We aspire to empower businesses and individuals with 
                                innovative technology solutions that drive growth and efficiency. 
                                We envision a future where technology seamlessly integrates into every 
                                aspect of our lives, simplifying processes and fostering limitless 
                                possibilities. With a commitment to excellence and a passion for innovation, 
                                we aim to be at the forefront of technological advancements, redefining industry 
                                standards and solving complex challenges. Together, we believe in shaping a future 
                                where technology serves as a 
                                powerful force for good, driving progress and prosperity for all.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            <span className="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                                <img className='w-[70px] h-[70px] sm:w-auto sm:h-auto' src={Mission} alt=''/>
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Our Mission</h1>

                                <p className="mt-3 text-gray-500 dark:text-gray-300">
                                At Dev Team Tech, our mission is to empower businesses 
                                and individuals through exceptional technology solutions that 
                                drive innovation, efficiency, and growth. We prioritize excellence, 
                                constantly striving for the highest standards in both our code and user 
                                experience. Embracing creativity and collaboration, we actively seek out novel 
                                solutions to complex problems, fostering open communication and trust. Our commitment 
                                to customer satisfaction drives us to listen attentively to our clients' needs and exceed 
                                their expectations. Dedicated to continuous improvement, we are always learning and refining our 
                                processes to stay at the forefront of technological advancements. Through these principles, we aim to be a 
                                trusted partner, helping our clients leverage 
                                technology to achieve their goals and drive sustainable success.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="md:flex md:items-start md:-mx-4">
                            <span className="inline-block p-2 text-blue-500 bg-blue-100 rounded-xl md:mx-4 dark:text-white dark:bg-blue-500">
                               <img className='w-[70px] h-[70px] sm:w-auto sm:h-auto' src={Logo} alt="" />
                                {/* <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div className="mt-4 md:mx-4 md:mt-0">
                                <h1 className="text-2xl font-semibold text-gray-700 capitalize dark:text-white">Our Team</h1>

                                <p className="mt-3 text-gray-500 dark:text-gray-300">
                                At Dev Team Tech, our team is comprised of highly skilled and 
                                passionate individuals who are dedicated to delivering exceptional 
                                results. With diverse backgrounds and expertise in various areas of 
                                technology, design, and development, our team collaborates seamlessly 
                                to tackle even the most complex challenges. We foster a culture of creativity, 
                                innovation, and continuous learning, empowering each team member to contribute their 
                                unique perspectives and skills. Committed to excellence, we uphold the highest standards 
                                in our work and strive to exceed expectations with every project. Together, we form a cohesive 
                                unit that is not only capable of delivering top-notch solutions but also dedicated to building 
                                strong relationships with our clients and ensuring their success.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hidden lg:flex lg:items-center lg:w-1/2 lg:justify-center">
                        <img className="w-[28rem] h-[28rem] object-cover xl:w-[34rem] xl:h-[34rem] rounded-full" src={Back} alt=""/>
                    </div>
                </div>
