...
// import Team1 from "../../assets/izunwaonu.jpg";
...
//           Discover our exceptional tech team, 
//           comprised of skilled professionals dedicated to advancing innovation and excellence
//             </p>
//       </div> 
//       <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
//           <div class="text-center text-gray-500 dark:text-gray-400">
//               <img alt="" class="mx-auto mb-4 w-36 h-36 rounded-full" src={Team1} />
//               <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
//                   <a href="#">Justus James Onuh</a>
//               </h3>
//               <p>CEO/Co-founder</p>
...
//           </div>
//           <div class="text-center text-gray-500 dark:text-gray-400">
//               <img class="mx-auto mb-4 w-36 h-36 rounded-full" src={Team1} alt=""/>
//               <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
//                   <a href="#">Sampson Chieme</a>
//               </h3>
//               <p>CTO/Co-founder</p>
//               <ul class="flex justify-center mt-4 space-x-4">
//                   <li>
